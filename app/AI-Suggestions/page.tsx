...
export default function AISuggestionsPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuggestions(
        Array.isArray(data.suggestions) ? data.suggestions : [data.suggestions],
      );
    } catch (err) {
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-default-500 max-w-2xl mx-auto">
          Get personalized tax-saving suggestions based on your financial
          profile using our advanced AI system.
        </p>
      </div>
          ...
          <CardHeader className="flex gap-3">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-small text-default-500">
                Enter your financial details for personalized suggestions
              </p>
            </div>
          </CardHeader>
          <CardBody>
          ...
          <CardBody>
            {loading ? (
              ...
              <div className="text-center text-default-500 py-8">
                Enter your financial details and click "Get AI Suggestions" to
        ...
        <CardBody>
          <div className="space-y-4">
            <p className="text-default-600">
              Our AI system analyzes your financial profile and provides
              personalized tax-saving suggestions based on:
            </p>
            ...
            <p className="text-default-600">
              The suggestions are generated using advanced algorithms and are
              updated regularly to reflect the latest tax regulations.
            </p>
          </div>
        </CardBody>
      </Card>
